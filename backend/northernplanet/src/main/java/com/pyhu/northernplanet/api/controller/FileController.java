...
//import com.pyhu.northernplanet.api.service.FileService;
...
//      return new ResponseEntity<List<FiledetailRes>>(fileservice.findbygroupid(filereq),
//          HttpStatus.OK);
//    } else {
...
//  public @ResponseBody
//  ResponseEntity<byte[]> getImage(@PathVariable int roomId, @PathVariable int userId,
//      @PathVariable int currentPage) throws IOException {
//    return new ResponseEntity<byte[]>(fileservice.getImage(roomId, userId, currentPage),
//        HttpStatus.OK);
//  }
//
...
//      @ApiResponse(code = 404, message = "사진 없음"), @ApiResponse(code = 500, message = "서버 오류")})
//  public @ResponseBody
//  ResponseEntity<List<String>> getAllImages(@PathVariable int roomId, @PathVariable int userId)
//      throws IOException {
//    return new ResponseEntity<List<String>>(fileservice.getAllImages(roomId, userId),
//        HttpStatus.OK);
//  }
//
//  @PostMapping("/delete")
