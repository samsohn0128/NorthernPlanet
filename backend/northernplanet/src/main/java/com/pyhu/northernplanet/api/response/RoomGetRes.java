...
public class RoomGetRes {
  ...
  public RoomGetRes(String name, String description, LocalDateTime startTime, int manager_id,
      String manager_name, int room_id, List<ParticipantGetRes> participants) {
    this.name = name;
  ...
  public RoomGetRes(String name, String description, LocalDateTime startTime, int manager_id,
      String manager_name, int room_id) {
    this.name = name;
    this.description = description;
    this.startTime = startTime;
    this.manager_id = manager_id;
