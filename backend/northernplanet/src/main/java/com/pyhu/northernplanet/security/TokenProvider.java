...
public class TokenProvider {
  ...
  public String createToken(Authentication authentication) {
    ...
    log.info("expiryDate: {}, appConfig.getAuth(): {}, \n expirationMsec: {}, tokensecret: {}", expiryDate, appConfig.getAuth(), appConfig.getAuth().getTokenExpirationMsec(), appConfig.getAuth().getTokenSecret());
